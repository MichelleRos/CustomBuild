...
def update_source(branch):
    ...
    app.logger.info('MIR: Updating to new branch: '+branch)
...
def generate():
    try:
        ...
        app.logger.info('MIR: generate: Chosen branch is %s' % chosen_branch)
...
def home2():
    ...
    app.logger.info('MIR: index2: Chosen branch is %s' % chosen_branch)
